...
DEPS = src/headers/game.h src/headers/graphics.h src/headers/sprite.h src/headers/player.h \
	   ...
	   src/headers/audio.h src/headers/endscreen.h src/headers/music.h
OBJ = main.o game.o level.o graphics.o sprite.o player.o lazer.o enemy.o textmanager.o audio.o endscreen.o music.o
